// Shrinks the tele exit building hud & adds a button icon to show which key is bound to that building (must be changed manually)
...
"Resource/UI/hud_obj_tele_exit.res"
{
	...
	{	
		...
		"labelText"		"6"			// Change this to your keybind for dispensers (2 characters max, or pick a smaller font)
