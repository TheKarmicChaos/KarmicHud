// Shrinks the dispenser building hud & adds a button icon to show which key is bound to that building (must be changed manually)
...
"Resource/UI/hud_obj_dispenser.res"
{
	...
	"KeyLabel"
	{
		...
		"labelText"		"4"			// Change this to your keybind for dispensers (2 characters max, or pick a smaller font)
